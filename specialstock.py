...
def main():
    ...
    for item in stock_list:
        ...
        if ipodate > startday:
            ...
            for currentyear in range(Fiveyearbefore,endyear+1):  
                ...
                if len(result_dividend) == 1:
                    ...
                    #     dividCash += result_dividend[dividend]["dividCashPsBeforeTax"]
        ...
        if not should_skip:
            stock = [item, MBRevenue_list[0], MBRevenue_list[1], MBRevenue_list[2], MBRevenue_list[3], MBRevenue_list[4], Netassets_list[0], Netassets_list[1], Netassets_list[2], Netassets_list[3], Netassets_list[4], netprofit_list[0], netprofit_list[1], netprofit_list[2], netprofit_list[3], netprofit_list[4], dividCash_list[0], dividCash_list[1], dividCash_list[2], dividCash_list[3], dividCash_list[4], ROE_list[0], ROE_list[1], ROE_list[2], ROE_list[3], ROE_list[4],dupontNitogr_list[0],dupontNitogr_list[1],dupontNitogr_list[2],dupontNitogr_list[3],dupontNitogr_list[4], cash_flow_ratio_list[0], cash_flow_ratio_list[1], cash_flow_ratio_list[2], cash_flow_ratio_list[3], cash_flow_ratio_list[4]]
            custom_columns = ["code", "总营收_4Y", "总营收_3Y", "总营收_2Y", "总营收_1Y", "总营收", "净资产_4Y", "净资产_3Y", "净资产_2Y", "净资产_1Y", "净资产", "净利润_4Y", "净利润_3Y", "净利润_2Y", "净利润_1Y", "净利润", "分红_4Y", "分红_3Y", "分红_2Y", "分红_1Y", "分红", "ROE_4Y","ROE_3Y","ROE_2Y","ROE_1Y","ROE", "净利润率_4Y", "净利润率_3Y", "净利润率_2Y", "净利润率_1Y", "净利润率", "现金流_4Y", "现金流_3Y", "现金流_2Y", "现金流_1Y", "现金流"]
